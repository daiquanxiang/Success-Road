...
- (void)setData:(NSData *)imageData {
    ...
    for (size_t i = 0; i < count; i++) {
        ...
        gifImage.duration = MAX(gifImage.duration, 0.01f);
...
- (void)showNextImage {
    ...
    self.timer = [NSTimer scheduledTimerWithTimeInterval:0.08f target:self selector:@selector(showNextImage) userInfo:nil repeats:NO];
}
